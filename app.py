...
app = dash.Dash(__name__, title="Movie Classifier", update_title=None, external_stylesheets=[dbc.themes.MATERIA])
server = app.server
app.layout = html.Div([
    html.Div([
    ...
    html.Div([
        html.Div([
            ...
            dcc.Textarea(
                ...
                style=dict(border="1px solid #ccc", borderRadius="4px", fontSize="13px", height="200px",
